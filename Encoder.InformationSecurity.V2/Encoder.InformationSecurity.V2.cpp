...
// Encoder.InformationSecurity.V2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CEncoderInformationSecurityV2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CEncoderInformationSecurityV2App

CEncoderInformationSecurityV2App::CEncoderInformationSecurityV2App()
{
...
// Единственный объект CEncoderInformationSecurityV2App

CEncoderInformationSecurityV2App theApp;


// Инициализация CEncoderInformationSecurityV2App

BOOL CEncoderInformationSecurityV2App::InitInstance()
{
	...
	CEncoderInformationSecurityV2Dlg dlg;
	m_pMainWnd = &dlg;
